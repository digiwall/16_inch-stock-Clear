...
{
    GPIO_Config_T BOARD_LED;

    BOARD_LED.mode = GPIO_MODE_OUT_OD;
    BOARD_LED.speed = GPIO_SPEED_10MHz;
    BOARD_LED.pin = g_ledGPIO[led].pin;

    GPIO_Config(g_ledGPIO[led].port, &BOARD_LED);
}
