...
to convert Channel 4 input voltage in Continuous conversion mode with interrupt.
...
After Initialization, PD3 can be connected to the VDD or GND.When connected to the VDD, the LED2
shuld be on and LED3 should be off.If connected to the GND, the LED2 will be off and
LED3 will be on.
