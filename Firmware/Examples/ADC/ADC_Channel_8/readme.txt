...
to convert Channel 8 internal voltage in continuous conversion mode with polling.
...
After Initialization, the voltage of adc channel 8 will always be printed on USART1(PD5).
