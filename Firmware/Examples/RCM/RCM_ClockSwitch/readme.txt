...
This example describes how to switch the master clock.
...
Pressing KEY1, master clock will be switched to HXT or HIRC. The clock can be visualized on CCO pin(PC4)
