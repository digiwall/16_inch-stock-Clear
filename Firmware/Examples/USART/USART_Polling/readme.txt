...
This example provides a basic communication between USART1 and USART2 using polling.
...
After Initialization, USART2 will send some data to USART1 using polling.
